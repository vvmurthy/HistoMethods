function [net, info] = cnn_train_histo(net, imdb, getBatch, varargin)
...
if isstr(opts.errorFunction)
  switch opts.errorFunction
    ...
    case 'multiclass'
      ...
      if isempty(opts.errorLabels), opts.errorLabels = {'top1e', 'roc'} ; end
    case 'binary'
...
%err(2,1) = auc_roc(predictions,labels);
